...
<div class="side-bar">
        ...
        <tbody>
            ...
            <tr class="event-wrapper" data-end-date="{{ $result->date_end }}"  data-description="{{ $result->description }}">
            <td>{{  $result->name}}</td>
            <td>{{  $result->title}}</td>
...
<div class="table-info" data-id="2">
        ...
        <tbody>
            ...
            <tr class="event-wrapper" data-end-date="{{ $group->date_end }}"  data-description="{{ $group->description }}">
            <td>{{  $group->title}}</td>
